...
cleader = plt.Circle((xcentre+(sq/2-1)*math.sin(math.radians(LH*30)),ycentre+(sq/2-1)*math.cos(math.radians(LH*30))),0.1, color = 'red')  
ax.add_patch(cleader)
